...
- Project page / docs: <https://unimib-datai.github.io/mammotab-docs/>
- Code repo (pipeline for generating/rebuilding the dataset): <https://github.com/unimib-datAI/mammotab>
...
- Official index page: <https://dumps.wikimedia.org/wikidatawiki/entities/>
...
- Hugging Face dataset page: <https://huggingface.co/datasets/osunlp/TableInstruct>
- Paper / code: <https://github.com/OSU-NLP-Group/TableLlama>
